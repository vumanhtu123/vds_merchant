...
import 'card/card.new.pin.reset.dart';
import 'new.pin.reset.controller.dart';

class NewPinResetPage extends GetView<NewPinResetController> {
  const NewPinResetPage({super.key});
            ...
            child: SizedBox(
                ...
                child: Column(
                  ...
                  children: [
                    ...
                    const Expanded(
                      child: CardNewPinResetComponent(),
                    ),
                  ],
                )),
          )
