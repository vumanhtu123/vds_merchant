...
import 'revoke.money.success.controller.dart';

class RevokeMoneySuccessPage extends GetView<RevokeMoneySuccessController> {
  const RevokeMoneySuccessPage({super.key});
    ...
    return WillPopScope(
      ...
      child: Scaffold(
        ...
        appBar: AppBar(
          ...
          centerTitle: true,
          elevation: 1,
          title: Text('Giao dịch thành công'.tr),
        ),
        bottomNavigationBar: Container(
          ...
          padding:
              const EdgeInsets.only(left: 16.0, right: 16, bottom: 30, top: 14),
          child: SizedBox(
            height: 42,
            child: BigButton(
                      ...
                      child: Column(
                        ...
                        children: [
                          ...
                          Padding(
                            ...
                            child: Text(
                              '${'Gửi yêu cầu rút tiền thành công'.tr}!',
                              style:
                          ...
                          Padding(
                            padding: const EdgeInsets.symmetric(horizontal: 15),
                            child: Text(
                              '${'Bạn đã tạo đề nghị rút tiền thành công, vui lòng chờ xác nhận của kế toán'.tr}.',
                          ...
                          // ),
                          // InfoWithTitle(
                          //   title: 'Số dư hiện tại'.tr,
                          //   isPrice: true,
                          //   info: Convert.convertMoney(
