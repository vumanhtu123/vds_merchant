...
class QrAccountStaffBinding extends Bindings {
  @override
  void dependencies() {
    Get.lazyPut<QrAccountStaffController>(() => QrAccountStaffController());
  }
}

class QrAccountStaffController extends BaseController {
