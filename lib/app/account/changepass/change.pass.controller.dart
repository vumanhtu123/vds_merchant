...
class ChangePassController extends BaseController {
  ...
  onValidateNewPass() {
    ...
    if (newPassword.isEmpty) {
      ...
      newPassError.value = "New password can't match old password";
    } else {
      newPassError.value = "";
    }
  }
    ...
    if (newPassError.isEmpty &&
      ...
      merchantChangePass(request).then((value) async {
        ...
        if (value.message == "Success") {
          ...
          // await showErrorChange(tittle: value.errorDescription!);
        }
