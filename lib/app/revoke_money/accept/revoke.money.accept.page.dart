...
import 'revoke.money.accept.controller.dart';

class RevokeMoneyAcceptPage extends GetView<RevokeMoneyAcceptController> {
  const RevokeMoneyAcceptPage({super.key});
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      appBar: AppBar(
        elevation: 1,
        title: Text('Xác nhận giao dịch'.tr),
      ),
      body: Obx(() {
            ...
            children: [
              Column(
                children: [
                  ...
                  InfoWithTitle(
                    title: 'Tài khoản nhận tiền'.tr,
                    info: controller.bankAccount.value,
                  ),
  ...
  Widget build(BuildContext context) {
    return Row(
      ...
      children: [
        ...
        Text(
          info,
          style: (info == "Miễn phí".tr && !isPrice)
              ? null
              : const TextStyle(
