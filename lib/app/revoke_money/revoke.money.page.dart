...
import 'revoke.money.controller.dart';

class RevokeMoneyPage extends GetView<RevokeMoneyController> {
  const RevokeMoneyPage({super.key});
        ...
        child: Scaffold(
            ...
            bottomNavigationBar: Padding(
              ...
              child: SizedBox(
                  height: 42,
                  child: BigButton(
                      function: controller.onNextClick, text: 'Tiếp tục'.tr)),
            ),
                ...
                () {
                  if (controller.appState.value == MerAppState.loading) {
                    ...
                    return InkWell(
                      ...
                      child: Center(
                        heightFactor: 18,
                        child: Text(controller.messageError ?? "", textAlign: TextAlign.center,),
                      ),
                    );
                  }
                  return Padding(
                    ...
                    child: Column(
                      ...
                      children: [
                        ...
                        TextFormFieldCustom(
                          ...
                          controller: controller.bankAccountTextController,
                          isCollapsed: true,
                          ...
                          errorMessage: controller.bankAccountError.value,
                        ),
                        ...
                        TextFormFieldCustom(
                          ...
                          onChanged: (text) => controller.onChangeText(text),
                        ...
                        // Text(
                        //   'Số tiền giao dịch không được nhỏ hơn: 50.000đ'.tr,
                        //   style: const TextStyle(
                        ...
                        TextFormFieldCustom(
                          ...
                          contentPadding: const EdgeInsets.only(
                              left: 30, top: 10, bottom: 10, right: -15),
                          borderFather: Border.all(
                              color: const Color(0xFFDFE0EB), width: 0.6),
                          controller: controller.contentAccountTextController,
                          isCollapsed: true,
                          maxLines: 7,
                          floatingLabelBehavior: FloatingLabelBehavior.never,
