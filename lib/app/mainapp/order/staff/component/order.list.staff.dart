...
import 'package:vds/app/mainapp/order/staff/staff.order.controller.dart';
...
class OrderListStaff extends GetView<StaffOrderController> {
  const OrderListStaff({super.key});
      ...
      children: [
        ...
        Expanded(
          child: Obx(() => RefreshIndicator(
              onRefresh: () => controller.staffOrder(),
...
class ChildOrder extends GetView<StaffOrderController> {
  const ChildOrder({
    Key? key,
    required this.order,
    required this.index,
  ...
  Widget build(BuildContext context) {
    return Column(
      ...
      children: [
        ...
        Expanded(
          child: Text(
            Convert.stringToDatePromotion(info),
